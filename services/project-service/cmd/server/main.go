...
func main() {
	...
	// API routes (v1)
	router.HandleFunc("GET /api/v1/projects", listProjectsHandler)
	router.HandleFunc("POST /api/v1/projects", createProjectHandler)
	router.HandleFunc("GET /api/v1/projects/{id}", getProjectHandler)
	router.HandleFunc("GET /api/v1/packlists/{id}", getPacklistHandler)
...
func listProjectsHandler(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusOK)
	w.Write([]byte(`{"data":[],"message":"not yet implemented","service":"project-service"}`))
}
...
func getPacklistHandler(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusOK)
	w.Write([]byte(`{"data":{},"message":"not yet implemented","service":"project-service"}`))
}
