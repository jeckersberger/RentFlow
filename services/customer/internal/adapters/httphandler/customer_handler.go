...
func NewCustomerHandler(customerService *application.CustomerService, logger zerolog.Logger) *CustomerHandler {
	return &CustomerHandler{
		customerService: customerService,
		logger:          logger.With().Str("handler", "customer").Logger(),
	}
}
...
func (h *CustomerHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	customer, err := h.customerService.GetByID(r.Context(), id, claims.TenantID)
	if err != nil {
		errors.HandleError(w, err)
		return
	}
...
func (h *CustomerHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	created, err := h.customerService.Create(r.Context(), claims.TenantID, req)
	if err != nil {
		errors.HandleError(w, err)
		return
	}
...
func (h *CustomerHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	updated, err := h.customerService.Update(r.Context(), id, claims.TenantID, req)
	if err != nil {
		errors.HandleError(w, err)
		return
	}
...
func (h *CustomerHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.customerService.Delete(r.Context(), id, claims.TenantID); err != nil {
		errors.HandleError(w, err)
		return
	}
...
func (h *CustomerHandler) Search(w http.ResponseWriter, r *http.Request) {
	...
	items, total, err := h.customerService.Search(r.Context(), claims.TenantID, query, p.Page, p.PerPage)
	if err != nil {
		errors.HandleError(w, err)
		return
	}
