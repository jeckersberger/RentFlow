...
var domainErrorMappings = []struct {
	...
	{"invalid packlist item status", Wrap(ErrBadRequest, "Ungueltiger Packlist-Item-Status")},
	{"invalid item status transition", Wrap(ErrBadRequest, "Ungueltiger Status-Uebergang fuer Packlist-Item")},
	{"packlist item not found", ErrNotFound},
