...
func Load() *Config {
	return &Config{
		...
		DBUser:            getEnv("DB_USER", "equipflow"),
		DBPassword:        getEnv("DB_PASSWORD", ""),
		DBName:            getEnv("DB_NAME", "equipflow"),
		RedisURL:          getEnv("REDIS_URL", "redis://localhost:6379"),
		JWTPrivateKeyPath: getEnv("JWT_PRIVATE_KEY_PATH", "/etc/equipflow/keys/private.pem"),
		JWTPublicKeyPath:  getEnv("JWT_PUBLIC_KEY_PATH", "/etc/equipflow/keys/public.pem"),
