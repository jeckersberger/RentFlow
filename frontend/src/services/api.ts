...
export const adminApi = {
  ...
  settings: () =>
    MOCK_MODE
      ? mockDelay({ company_name: 'EquipFlow GmbH', timezone: 'Europe/Berlin', language: 'de-DE' })
  ...
  getVersion: () =>
    MOCK_MODE
      ? mockDelay({
          ...
          release_url: 'https://github.com/jeckersberger/EquipFlow/releases/tag/v1.0.1',
